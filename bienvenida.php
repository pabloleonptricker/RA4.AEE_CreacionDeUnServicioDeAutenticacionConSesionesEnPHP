...
<head>
    ...
    <style>
        body {
            ...
            background-color: #eef2ff; /* Color de fondo suave */
        }
    </style>
</head>
<body class="flex items-center justify-center min-h-screen p-4">
    ...
    <div class="w-full max-w-lg bg-white rounded-2xl shadow-2xl p-8 sm:p-10 border-t-4 border-indigo-600">

        <header class="text-center mb-8">
            <h1 class="text-4xl font-extrabold text-indigo-600">¡Bienvenido al Área Segura!</h1>
        </header>

        <!-- Contenido Personalizado (Requisito 2) -->
        <div class="space-y-6 text-gray-700">
            
            <!-- Mensaje de Bienvenida -->
            <div class="p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                <p class="text-xl font-semibold">Hola, <?php echo htmlspecialchars(ucfirst($nombre_usuario)); ?>!</p>
            ...
            <div class="flex flex-col sm:flex-row justify-between text-base">
                <div class="bg-gray-100 p-3 rounded-lg flex items-center mb-3 sm:mb-0">
                    <svg class="w-5 h-5 mr-2 text-indigo-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l3 3a1 1 0 001.414-1.414L11 9.586V6z" clip-rule="evenodd"></path></svg>
                    <span class="font-medium text-gray-800">Hora de Acceso:</span> <?php echo $hora_login; ?>
                </div>
                <div class="bg-gray-100 p-3 rounded-lg flex items-center">
                    <svg class="w-5 h-5 mr-2 text-indigo-500" fill="currentColor" viewBox="0 0 20 20"><path d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z"></path></svg>
                    <span class="font-medium text-gray-800">Fecha Actual:</span> <?php echo $fecha_actual; ?>
                </div>
            </div>
            
        </div>

        <!-- Funcionalidad para Cerrar Sesión (Requisito 4) -->
